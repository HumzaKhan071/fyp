...
import 'package:doctor_ui/p.auth/p.signup.dart';
import 'package:doctor_ui/screens/HomePage.dart';
            ...
            SizedBox(
                ...
                child: ElevatedButton(
                    onPressed: () {
                      print(txt.text);
                      print(pass.text);
                      signIn(txt.text, pass.text, context);
                    },
                    child: Text('Sign In')))
          ],
        ));
...
void signIn(email, pass, BuildContext context) async {
  try {
